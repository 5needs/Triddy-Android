...
public class ChatListActivity extends AppCompatActivity implements ChatListAdapter.OnChatListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public static final String CHATID = "com.example.myfirstapp.CHATID";
    public static final String USER = "com.example.myfirstapp.USER";
    ...
    private void configureRecyclerView(){
        ...
        chatsViewModel.getChats(token, "user1").observe(this, chats -> {
            runOnUiThread(() -> {
